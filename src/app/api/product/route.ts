...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const { equipmentName, equipmentOwn, categoryId, equipmentTypeId, aboutEquipment, serialNo, brand } = data;
        const { rentalPriceCurrent, rentalPricePre, equipmentPrice, unitName, stockStatus, purchaseDate } = aboutEquipment as AboutEquipment;
            ...
            await prisma.$transaction(async (tx) => {
                ...
                await tx.aboutEquipment.create({
                    data: {
                        ...
                        rentalPriceCurrent, rentalPricePre, equipmentPrice,
