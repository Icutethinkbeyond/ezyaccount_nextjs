...
const PurchaseOrderTable: React.FC<ProductTableProps> = ({ data }) => {
  ...
  //   router.push("/expenses/purchase-order/new-purchase-order");
  // };
  ...
  return (
    ...
    //           <Typography variant="h3">ใบสั่งซื้อ</Typography>
    //           <IconButton
    //             color="primary"
