...
const ReceiptTable: React.FC<ProductTableProps> = ({ data }) => {
  ...
  const handleAddClick = () => {
    ...
    router.push("/expenses/receipt/new-receipt");
  };
  ...
  return (
    <BaseCard title="Receipt Table">
      <>
      <Grid2 container mb={1}>
          <Grid2 size={6}>
            <Box display="flex" alignItems="center" gap={2}>
              <Typography variant="h3">ใบรับสินค้า</Typography>
              <IconButton
                color="primary"
