...
const WithholdingSlipsTable: React.FC<ProductTableProps> = ({ data }) => {
  ...
  //   router.push("/expenses/withholding-slip/new-withholding-slip");
  // };
...
export default WithholdingSlipsTable;
