...
const SalesSummaryCustomerTable: React.FC<ProductTableProps> = ({ data }) => {
  ...
  return (
    <BaseCard title="Sale Summary Customer Table">
      <DataGrid
...
export default SalesSummaryCustomerTable;
